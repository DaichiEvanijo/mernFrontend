...
export const registerSchema = z
  .object({
    user: z
      ...
      .regex(
        USER_REGEX,
        "4 to 24 characters and must begin with a letter.Letters, numbers, underscores, hyphens allowed. Allowed special character."
      ),
    pwd: z
      .string()
      .regex(
        PWD_REGEX,
        "8 to 24 characters. must include uppercase and lowecase letters. must include uppercase and lowecase letters"
      ),
    matchPwd: z.string(),
  })
