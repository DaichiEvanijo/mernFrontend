...
export const addNewPost = createAsyncThunk(
  "posts/addNewPost",
  async ({ initialPost, axiosPrivate }: AddNewPostProps) => {
    try {
...
export const updatePost = createAsyncThunk(
  "posts/updatePost",
  async ({ initialPost, axiosPrivate }: UpdatePostProps) => {
...
export const deletePost = createAsyncThunk(
  "posts/deletePost",
  async ({ initialPost, axiosPrivate }: DeletePostProps) => {
    const { _id } = initialPost;
    try {
...
export const addReaction = createAsyncThunk(
  "posts/addReaction",
  async ({ reactionData, axiosPrivate }: AddReactionProps) => {
    try {
